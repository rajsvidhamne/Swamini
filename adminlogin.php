...
box-shadow: 0px 0px 14px 0px rgba(0,0,0,0.24);}
    ...
    border-bottom: 1px solid #BF8648 !important;
...
<form action="" method="post" name="form4">
		...
		<div class="form-group">
            ...
            <input type="text" id="form2" class="form-control input-lg" name="em" required>
            
		</div>

        <div class="form-group">
		    <label for="form4">Your Password</label>
            <input type="password" id="form4" class="form-control input-lg" name="pass" required>
...
$us=$_POST["em"];
$p=$_POST["pass"];
$q1="select * from login where username='$us' and password='$p'";
