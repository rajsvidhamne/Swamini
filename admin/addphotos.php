...
$cid=0;
$q="select * from gallery where (select max(pid)from gallery) ";
    ...
    <form  method="post"  id=frmreg  name="myForm" enctype="multipart/form-data">
		...
		<div class="form-group">
			<div class="input-group">
				...
				<input type="text" class="form-control" name="pid" placeholder="Picture ID" required="required" value="<?php echo $cid +1;?>">
			</div>
        </div>
...
$q="insert into gallery values('$pid','$fn')";
mysqli_query($cn,$q);
mysqli_close($cn);
echo"<script>alert('Photo Added Successfully');window.location='addphotos.php'</script>";
}
