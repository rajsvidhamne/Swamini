...
<h2 style="text-align:center; font-family: 'Cinzel Decorative';font-size: 25px; font-weight:bold; color:black;">Achievements Of Suvarna</h2>
<div class="row">
	<?php
	include("connection.php");
	$rs=mysqli_query($cn,"select * from achievement ");
	$i=0;
	...
	echo "<h4 style='\text-align:center\'>$des</h4>";
